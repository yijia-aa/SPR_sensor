...
def FoM():
    ...
    # list of layer thicknesses in nm
            d_list = [inf, t, (h+g*k), inf]
    # list of refractive indices
            n_list = [1.7847, 0.056253+4.2760j, 2.7302+1.3555j, 1.374] # 3% increase in RI
            s_list = [1.7847, 0.056253+4.2760j, 2.7302+1.3555j, 1.334] # original RI
    # wavelength in nm
            lam_vac = 632.8
    ...
    # initialize lists of y-values to plot
            ...
            print ("FoM " + str(t) + ", " + str(h+g*k) + " = " + str(d/c))
            plt.show()
