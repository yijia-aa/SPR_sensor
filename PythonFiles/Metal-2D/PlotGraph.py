...
def FoM():
    ...
    d_list_1 = [inf, 31, 12, 0.8, 0.34, inf]
    d_list_2 = [inf, 31, 12, 0.8, 0.34, inf]
    
    # list of refractive indices
    n_list = [1.52, 0.0806+4.2210j, 0.2198+3.321j, 4.8936+0.313j, 3+1.149j, 1.374] 
    s_list = [1.52, 0.0806+4.2210j, 0.2198+3.321j, 4.8936+0.313j, 3+1.149j, 1.334]
