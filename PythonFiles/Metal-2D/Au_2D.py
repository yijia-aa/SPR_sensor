...
def FoM():
    ...
    d_list = [inf, 13, 80, inf] # with graphene (2D)
    # list of refractive indices 
    n_list = [1.7847, 0.2231+3.294j, 3+1.149106j, 1.466] # 10% increase in RI
    s_list = [1.7847, 0.2231+3.294j, 3+1.149106j, 1.333] # original RI
    # wavelength in nm
    lam_vac = 633
