...
def FoM():
    ...
    d_list = [inf, 30, 12, 0.335, inf]
    # list of refractive indices
    n_list = [1.52, 0.0806+4.2210j, 0.2198+3.3209j, 3+1.149106j, 1.372] 
    s_list = [1.52, 0.0806+4.2210j, 0.2198+3.3209j, 3+1.149106j, 1.332] 
    # wavelength in nm
    lam_vac = 633
    # list of angles to plot
    theta_list = linspace(60*degree, 90*degree, num=3000)
