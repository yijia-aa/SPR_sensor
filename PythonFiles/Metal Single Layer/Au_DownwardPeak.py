...
def FoM():
    ...
    """
    for t in range (40,100,1):
        # list of layer thicknesses in nm
        d_list = [inf, t, inf]
        # list of refractive indices
        n_list = [1.7847, 0.18377+3.4313j, 1.374] # 3% increase in RI
        s_list = [1.7847, 0.18377+3.4313j, 1.334] # original RI
        # wavelength in nm
        lam_vac = 632.8
        ...
        d = a-b
        # print ("FWHM" + str(t) + "= " + str(c))
        # print ("Sensitivity" + str(t) + "= " + str(d))
        print ("FoM" + str(t) + "= " + str(d/c))
