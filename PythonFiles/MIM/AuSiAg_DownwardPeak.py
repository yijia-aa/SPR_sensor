...
def FoM():
    ...
    """
    for t in range (13,18,1):
        for g in range (13,18,1):
            for h in range (43,48,1):
    # list of layer thicknesses in nm
                d_list = [inf, t, g, h, inf]
    # list of refractive indices
                n_list = [1.7847, 0.18377+3.4313j, 3.8827+0.019626j, 0.056253+4.2760j, 1.374] # 3% increase in RI
                s_list = [1.7847, 0.18377+3.4313j, 3.8827+0.019626j, 0.056253+4.2760j, 1.334] # original RI
    # wavelength in nm
                lam_vac = 632.8
