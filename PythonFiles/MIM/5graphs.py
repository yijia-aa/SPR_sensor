...
def FoM():
    ...
    d_list_1 = [inf, 31, 20, 12, 0.8, inf] #blue
    d_list_2 = [inf, 31, 170, 12, 0.8, inf] #black
    d_list_3 = [inf, 31, 200, 12, 0.8, inf] #purple
    d_list_4 = [inf, 31, 280, 12, 0.8, inf] #green
    d_list_5 = [inf, 31, 300, 12, 0.8, inf] #red
    
    # list of refractive indices
    n_list = [1.52, 0.0806+4.221j, 1.91, 0.2198+3.321j, 4.8936+0.313j, 1.384] # 3% increase in RI
    s_list = [1.52, 0.0806+4.221j, 1.91, 0.2198+3.321j, 4.8936+0.313j, 1.334] # original RI
    # wavelength in nm
    lam_vac = 632.8
