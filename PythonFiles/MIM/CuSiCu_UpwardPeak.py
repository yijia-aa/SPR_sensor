...
def FoM():
    ...
    for t in range (5,55,10):
        for g in range (5,25,10):
            for h in range (5,35,10):
    # list of layer thicknesses in nm
                d_list = [inf, t, g, h, inf]
    # list of refractive indices
                n_list = [1.7847, 0.27002+3.4081j, 3.8827+0.019626j, 0.27002+3.4081j, 1.374] # 3% increase in RI
                s_list = [1.7847, 0.27002+3.4081j, 3.8827+0.019626j, 0.27002+3.4081j, 1.334] # original RI
    # wavelength in nm
                lam_vac = 632.8
