...
def FoM():
    ...
    d_list = [inf, 13, 1, 46, inf]
    # list of refra3tive indices
    n_list = [1.7847, 0.056253+4.2760j, 1.4570, 0.056253+4.2760j, 1.374] # 3% increase in RI
    s_list = [1.7847, 0.056253+4.2760j, 1.4570, 0.056253+4.2760j, 1.334] # original RI
    # wavelength in nm
    lam_vac = 632.8
