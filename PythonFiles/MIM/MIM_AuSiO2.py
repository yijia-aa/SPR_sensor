...
def FoM():
    ...
    d_list = [inf, 22, 100, 22, inf]
    # list of refractive indices
    n_list = [2.5836, 0.2231+3.294j, 1.4584, 0.2231+3.294j, 1.466] # 10% increase in RI
    s_list = [2.5836, 0.2231+3.294j, 1.4584, 0.2231+3.294j, 1.333] # original RI
    # wavelength in nm
    lam_vac = 633
    # list of angles to plot
    theta_list = linspace(20*degree, 80*degree, num=300)
