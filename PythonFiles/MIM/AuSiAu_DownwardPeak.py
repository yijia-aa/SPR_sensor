...
def FoM():
    ...
    # list of refractive indices
                n_list = [1.7847, 0.18377+3.4313j, 3.8827+0.019626j, 0.18377+3.4313j, 1.374] # 3% increase in RI
                s_list = [1.7847, 0.18377+3.4313j, 3.8827+0.019626j, 0.18377+3.4313j, 1.334] # original RI
    # wavelength in nm
                lam_vac = 632.8
