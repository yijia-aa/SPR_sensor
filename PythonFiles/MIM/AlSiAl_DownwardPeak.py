...
def FoM():
    ...
    for t in range (2,7,1):
        for g in range (2,7,1):
            for h in range (23,28,1):
    # list of layer thicknesses in nm
                d_list = [inf, t, g, h, inf]
    # list of refractive indices
                n_list = [1.7847, 1.4482+7.5367j, 3.8827+0.019626j, 1.4482+7.5367j, 1.374] # 3% increase in RI
                s_list = [1.7847, 1.4482+7.5367j, 3.8827+0.019626j, 1.4482+7.5367j, 1.334] # original RI
    # wavelength in nm
                lam_vac = 632.8
