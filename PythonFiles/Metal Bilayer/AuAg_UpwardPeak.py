...
def FoM():
    ...
    for t in range (0,10,1):
        for g in range (20,30,1):
    # list of layer thicknesses in nm
            d_list = [inf, t, g, inf]
    # list of refractive indices
            n_list = [1.7847, 0.18377+3.4313j, 0.056253+4.2760j, 1.374] # 3% increase in RI
            s_list = [1.7847, 0.18377+3.4313j, 0.056253+4.2760j, 1.334] # original RI
    # wavelength in nm
            lam_vac = 632.8
