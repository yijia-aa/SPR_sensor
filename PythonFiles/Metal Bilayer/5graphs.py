...
def FoM():
    ...
    d_list_1 = [inf, 51, 0, inf]
    d_list_2 = [inf, 31, 12, inf]
    d_list_3 = [inf, 21, 20, inf]
    d_list_4 = [inf, 11, 30, inf]
    d_list_5 = [inf, 0, 46, inf]
    
    # list of refractive indices
    n_list = [1.52, 0.0806+4.221j, 0.2198+3.321j, 1.374] # 3% increase in RI
    s_list = [1.52, 0.0806+4.221j, 0.2198+3.321j, 1.334] # original RI
    # wavelength in nm
    lam_vac = 632.8
